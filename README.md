...
| Grafana | 3000 | Unified dashboard — traces, metrics, logs |
...
- [ ] **Docs site** — [MkDocs + Material](https://squidfunk.github.io/mkdocs-material/) deployed to GitHub Pages, autogenerated from the `docs/` directory with OpenAPI-derived API references per service
