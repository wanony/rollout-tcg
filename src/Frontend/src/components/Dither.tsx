...
function DitheredWaves({
  ...
  return (
    <>
      ...
      <mesh onPointerMove={handlePointerMove} position={[0, 0, 0.01]}
        scale={[viewport.width, viewport.height, 1]} visible={false}>
        <planeGeometry args={[1, 1]} />
...
export default function Dither({
  ...
  return (
    <Canvas camera={{ position: [0, 0, 6] }} dpr={1} gl={{ antialias: true }}>
      <DitheredWaves
